...
.field static final mActivityTriggerTE:Lcom/android/internal/app/ActivityTriggerTE;
...
.method static constructor <clinit>()V
    ...
    .line 310
    new-instance v0, Lcom/android/internal/app/ActivityTriggerTE;

    invoke-direct {v0}, Lcom/android/internal/app/ActivityTriggerTE;-><init>()V

    sput-object v0, Lcom/android/server/am/ActivityStack;->mActivityTriggerTE:Lcom/android/internal/app/ActivityTriggerTE;
...
.method constructor <init>(Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;)V
    ...
    .line 163
    iput-object v3, p0, Lcom/android/server/am/ActivityStack;->mPerf:Lorg/codeaurora/Performance;
    ...
    const v3, #android:bool@config_enablePerfBoostForAnimation#t
    ...
    .line 418
    iget-boolean v2, p0, Lcom/android/server/am/ActivityStack;->mIsAnimationBoostEnabled:Z
    ...
    const v3, #android:integer@animationboost_schedboost_param#t
    ...
    const v3, #android:integer@animationboost_timeout_param#t
    ...
    const v3, #android:integer@animationboost_cpuboost_param#t
...
.method private removeActivityFromHistoryLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    const-string v2, "LGSetupWizard/.SetupWelcome"
...
.method private triggerApkDelete(Ljava/lang/String;)V
    ...
    const-string v3, "[LGE][SBP] ActivityStack:: LGSetupWizard/.SetupWelcome is "
    ...
    const-string v3, "[LGE][SBP] ActivityStack:: LGSetupWizard/.SetupWelcome ["
...
.method final activityStoppedLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;Landroid/os/PersistableBundle;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v1, v2, v4}, Lcom/android/server/am/ActivityManagerService;->notifyTaskPersisterLocked(Lcom/android/server/am/TaskRecord;Z)V
    ...
    invoke-virtual {p1, v1, p4}, Lcom/android/server/am/ActivityRecord;->updateThumbnail(Landroid/graphics/Bitmap;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v1, p1, v4}, Lcom/android/server/am/ActivityStackSupervisor;->requestVisibleBehindLocked(Lcom/android/server/am/ActivityRecord;Z)Z
    ...
    :goto_1
    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/ActivityStack;->mPowerManager:Landroid/os/PowerManager;
    ...
    invoke-virtual {v1, v2, v3, v4}, Landroid/os/PowerManager;->notifyActivityState(III)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v2, "Exception thrown during send state to powermanager : "
    ...
    invoke-virtual {p0, p1, v5, v1}, Lcom/android/server/am/ActivityStack;->destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZLjava/lang/String;)Z
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/am/ActivityStackSupervisor;->updatePreviousProcessLocked(Lcom/android/server/am/ActivityRecord;)V
...
.method final finishActivityLocked(Lcom/android/server/am/ActivityRecord;ILandroid/content/Intent;Ljava/lang/String;Z)Z
    ...
    const-string v9, "next is null in finishActivityLocked"
    ...
    invoke-virtual {v8, v7}, Lcom/android/server/am/ActivityStackSupervisor;->endLockTaskModeIfTaskEnding(Lcom/android/server/am/TaskRecord;)V
    ...
    const-string v10, "r.frontOfTask = true is transferred to ActivityRecord: "
...
.method final resumeTopActivityInnerLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    .line 1817
    sget-object v3, Lcom/android/server/am/ActivityStack;->mActivityTriggerTE:Lcom/android/internal/app/ActivityTriggerTE;

    move-object/from16 v0, v26

    iget-object v4, v0, Lcom/android/server/am/ActivityRecord;->intent:Landroid/content/Intent;

    invoke-virtual {v3, v4}, Lcom/android/internal/app/ActivityTriggerTE;->activityResumeTrigger(Landroid/content/Intent;)V
    ...
    iget-object v3, v3, Lcom/android/server/am/ActivityStackSupervisor;->mHelperBoost:Lcom/lge/loader/LGContextHelper;
    ...
    new-instance v4, Lcom/lge/loader/LGContextHelper;
    ...
    invoke-direct {v4, v5}, Lcom/lge/loader/LGContextHelper;-><init>(Landroid/content/Context;)V

    iput-object v4, v3, Lcom/android/server/am/ActivityStackSupervisor;->mHelperBoost:Lcom/lge/loader/LGContextHelper;
    :try_end_1
    ...
    const-string v5, "lgpowermanagerhelper"

    invoke-virtual {v3, v5}, Lcom/lge/loader/LGContextHelper;->getLGSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lcom/lge/loader/power/ILGPowerManagerLoader;

    iput-object v3, v4, Lcom/android/server/am/ActivityStackSupervisor;->mLGPowerManagerLoader:Lcom/lge/loader/power/ILGPowerManagerLoader;
    :try_end_2
    ...
    iget-object v3, v3, Lcom/android/server/am/ActivityStackSupervisor;->mLGPowerManagerLoader:Lcom/lge/loader/power/ILGPowerManagerLoader;
    ...
    iget-object v4, v4, Lcom/android/server/am/ActivityStackSupervisor;->mLGPowerManagerLoader:Lcom/lge/loader/power/ILGPowerManagerLoader;

    const/16 v4, 0x8

    invoke-interface {v3, v4}, Lcom/lge/loader/power/ILGPowerManagerLoader;->boost(I)I
...
.method startActivityLocked(Lcom/android/server/am/ActivityRecord;ZZZLandroid/os/Bundle;)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/internal/app/ActivityTriggerTE;->activityStartTrigger(Landroid/content/Intent;)V
...
.method final startPausingLocked(ZZZZ)Z
    ...
    .line 929
    .local v11, "prevActivityName":Ljava/lang/String;
    :try_start_0
    iget-object v0, v1, Lcom/android/server/am/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;
    ...
    const-string v0, "com.lge.smartcover.PouchLockScreen"
    ...
    .line 940
    .end local v11    # "prevActivityName":Ljava/lang/String;
    :cond_9
    :goto_2
    ...
    .restart local v11    # "prevActivityName":Ljava/lang/String;
    :catch_0
    move-exception v8
    ...
    const-string v2, "updateThumbnail exception !!"
