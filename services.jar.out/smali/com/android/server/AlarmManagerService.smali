...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/AlarmManagerService$DataSchedulerReceiver;,
...
.field private static final DEBUG_DATASCHEDULER:Z
...
.field private static final LGE_ALARM_PACKAGE:Ljava/lang/String; = "com.lge.clock"
...
.field private static final TAG_DS:Ljava/lang/String; = "AlarmManager-DataScheduler"
...
.field private mDataSchedulerEnabled:Z

.field private mDataSchedulerReceiver:Lcom/android/server/AlarmManagerService$DataSchedulerReceiver;
...
.field private mIsControlExactType:Z
...
.field private mUsePowerOffAlarm:Z

.field mWakeLock:Landroid/os/PowerManager$WakeLock;

.field private mWakeupBeforAlarm:J
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/AlarmManagerService;->DEBUG_DATASCHEDULER:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-wide v0, p0, Lcom/android/server/AlarmManagerService;->mWakeupBeforAlarm:J
    ...
    .line 167
    iput-boolean v2, p0, Lcom/android/server/AlarmManagerService;->mUsePowerOffAlarm:Z
    ...
    .line 2440
    iput-boolean v2, p0, Lcom/android/server/AlarmManagerService;->mDataSchedulerEnabled:Z

    .line 2441
    iput-boolean v2, p0, Lcom/android/server/AlarmManagerService;->mIsControlExactType:Z
...
.method static synthetic access$1000(Lcom/android/server/AlarmManagerService;)Z
    ...
    .prologue
    .line 87
    iget-boolean v0, p0, Lcom/android/server/AlarmManagerService;->mDataSchedulerEnabled:Z
...
.method static synthetic access$1002(Lcom/android/server/AlarmManagerService;Z)Z
    ...
    .prologue
    .line 87
    iput-boolean p1, p0, Lcom/android/server/AlarmManagerService;->mDataSchedulerEnabled:Z
...
.method static synthetic access$1100()Z
    ...
    .prologue
    .line 87
    sget-boolean v0, Lcom/android/server/AlarmManagerService;->DEBUG_DATASCHEDULER:Z
...
.method private configPowerOffAlarm(IJLandroid/app/PendingIntent;)I
    .locals 8
    .param p1, "type"    # I
    ...
    .prologue
    .line 868
    iget-boolean v2, p0, Lcom/android/server/AlarmManagerService;->mUsePowerOffAlarm:Z
    ...
    iget-wide v6, p0, Lcom/android/server/AlarmManagerService;->mWakeupBeforAlarm:J
    ...
    .line 877
    invoke-direct {p0, v0, v1}, Lcom/android/server/AlarmManagerService;->set_rtc(J)V

    .line 878
    const/4 v2, 0x1

    invoke-direct {p0, v2}, Lcom/android/server/AlarmManagerService;->poweroff_flag_rtc(Z)V

    .line 895
    .end local v0    # "powerupSecond":J
    :cond_0
    :goto_0
    const/4 v2, 0x4
    ...
    .line 881
    .restart local v0    # "powerupSecond":J
    :cond_2
    ...
    const-string v4, "Powerup seconds is invalid"
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/AlarmManagerService;->setPowerOffAlarmEnabledImpl(Z)V
    ...
    .line 890
    iput-wide p2, p0, Lcom/android/server/AlarmManagerService;->mWakeupBeforAlarm:J
...
.method private needToSync(ILandroid/app/PendingIntent;JJ)Z
    .locals 9
    .param p1, "uid"    # I
    .param p2, "operation"    # Landroid/app/PendingIntent;
    .param p3, "interval"    # J
    .param p5, "whenElapsedFromNow"    # J
    ...
    .line 2464
    iget-boolean v3, p0, Lcom/android/server/AlarmManagerService;->mDataSchedulerEnabled:Z
...
.method private native poweroff_flag_rtc(Z)V
.end method
...
.method private setImplLocked(IJJJJJLandroid/app/PendingIntent;ZZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;IJJIIJ)V
    .locals 28
    .param p1, "type"    # I
    .param p2, "when"    # J
    ...
    .param p17, "userId"    # I
    .param p18, "originalWhen"    # J
    .param p20, "whenElapsedFromNow"    # J
    .param p22, "uid"    # I
    .param p23, "pid"    # I
    .param p24, "originalWindowLength"    # J
    ...
    invoke-direct/range {v6 .. v25}, Lcom/android/server/AlarmManagerService$Alarm;-><init>(IJJJJJLandroid/app/PendingIntent;Landroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;IJJ)V
    ...
    iput v0, v6, Lcom/android/server/AlarmManagerService$Alarm;->uid:I

    .line 932
    move/from16 v0, p23

    iput v0, v6, Lcom/android/server/AlarmManagerService$Alarm;->pid:I
    ...
    iput-wide v0, v6, Lcom/android/server/AlarmManagerService$Alarm;->whenElapsedFromNow:J
    ...
    .line 941
    .local v27, "whichBatch":I
    :goto_0
    if-gez v27, :cond_5

    .line 942
    new-instance v26, Lcom/android/server/AlarmManagerService$Batch;
    ...
    .line 946
    .restart local v27    # "whichBatch":I
    :cond_5
    move-object/from16 v0, p0
...
.method private native set_rtc(J)V
.end method

.method private toCurrentTimeString(JI)Ljava/lang/String;
    .locals 9
    .param p1, "time"    # J
    .param p3, "type"    # I
    ...
    invoke-static {p1, p2, p3}, Lcom/android/server/AlarmManagerService;->convertToElapsed(JI)J
...
.method deliverAlarmsLocked(Ljava/util/ArrayList;J)V
    ...
    .line 1986
    .local v21, "triggerSchedulingList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/net/DataSchedulerAppInfo;>;"
    const/16 v20, 0x0
    ...
    iget v9, v0, Lcom/android/server/AlarmManagerService$Alarm;->count:I
    ...
    iget-object v9, v0, Lcom/android/server/AlarmManagerService$Alarm;->tag:Ljava/lang/String;
    ...
    iget-wide v10, v0, Lcom/android/server/AlarmManagerService$Alarm;->whenElapsedFromNow:J

    move-object/from16 v5, p0

    invoke-direct/range {v5 .. v11}, Lcom/android/server/AlarmManagerService;->needToSync(ILandroid/app/PendingIntent;JJ)Z
    ...
    .line 2050
    sget-boolean v5, Lcom/android/server/AlarmManagerService;->DEBUG_DATASCHEDULER:Z

    if-eqz v5, :cond_a

    .line 2051
    const-string v5, "AlarmManager-DataScheduler"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "wake up : uid ("
    ...
    .line 2053
    :cond_a
    new-instance v6, Landroid/net/DataSchedulerAppInfo;
    ...
    iget v8, v0, Lcom/android/server/AlarmManagerService$Alarm;->pid:I
    ...
    iget-wide v14, v0, Lcom/android/server/AlarmManagerService$Alarm;->originalWindowLength:J

    invoke-direct/range {v6 .. v15}, Landroid/net/DataSchedulerAppInfo;-><init>(IILjava/lang/String;JJJ)V
    ...
    new-array v5, v5, [Landroid/net/DataSchedulerAppInfo;
    ...
    check-cast v5, [Landroid/net/DataSchedulerAppInfo;

    invoke-virtual {v6, v5}, Landroid/net/DataSchedulerManager;->updateAppInfo([Landroid/net/DataSchedulerAppInfo;)V
...
.method public onStart()V
    ...
    sget v4, Lcom/lge/internal/R$bool;->config_usePowerOffAlarm:I

    invoke-virtual {v3, v4}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/server/AlarmManagerService;->mUsePowerOffAlarm:Z
    ...
    .line 680
    new-instance v3, Lcom/android/server/AlarmManagerService$DataSchedulerReceiver;

    invoke-direct {v3, p0}, Lcom/android/server/AlarmManagerService$DataSchedulerReceiver;-><init>(Lcom/android/server/AlarmManagerService;)V

    iput-object v3, p0, Lcom/android/server/AlarmManagerService;->mDataSchedulerReceiver:Lcom/android/server/AlarmManagerService$DataSchedulerReceiver;
    ...
    iput-boolean v3, p0, Lcom/android/server/AlarmManagerService;->mDataSchedulerEnabled:Z

    .line 682
    const-string v3, "persist.lg.data.llkklk.exact"

    invoke-static {v3, v6}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/server/AlarmManagerService;->mIsControlExactType:Z
...
.method rebatchAllAlarmsLocked(Z)V
    ...
    .line 546
    .local v38, "oldSet":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/AlarmManagerService$Batch;>;"
    move-object/from16 v0, p0
    ...
    .line 549
    .local v37, "oldBatches":I
    const/16 v35, 0x0

    .local v35, "batchNum":I
    :goto_0
    move/from16 v0, v35
    ...
    check-cast v34, Lcom/android/server/AlarmManagerService$Batch;

    .line 551
    .local v34, "batch":Lcom/android/server/AlarmManagerService$Batch;
    invoke-virtual/range {v34 .. v34}, Lcom/android/server/AlarmManagerService$Batch;->size()I
    ...
    .line 554
    .local v33, "a":Lcom/android/server/AlarmManagerService$Alarm;
    ...
    iget-wide v0, v0, Lcom/android/server/AlarmManagerService$Alarm;->originalWhen:J

    move-wide/from16 v24, v0

    move-object/from16 v0, v33

    iget-wide v0, v0, Lcom/android/server/AlarmManagerService$Alarm;->whenElapsedFromNow:J
    ...
    iget v0, v0, Lcom/android/server/AlarmManagerService$Alarm;->pid:I

    move/from16 v29, v0

    move-object/from16 v0, v33

    iget-wide v0, v0, Lcom/android/server/AlarmManagerService$Alarm;->originalWindowLength:J
    ...
    invoke-direct/range {v6 .. v31}, Lcom/android/server/AlarmManagerService;->setImplLocked(IJJJJJLandroid/app/PendingIntent;ZZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;IJJIIJ)V
    ...
    .end local v33    # "a":Lcom/android/server/AlarmManagerService$Alarm;
    :cond_2
    ...
    .line 580
    .end local v32    # "N":I
    .end local v34    # "batch":Lcom/android/server/AlarmManagerService$Batch;
    .end local v36    # "i":I
    :cond_3
    return-void
.end method
...
.method setImpl(IJJJLandroid/app/PendingIntent;ZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;)V
    ...
    iget-boolean v7, v0, Lcom/android/server/AlarmManagerService;->mUsePowerOffAlarm:Z
    ...
    .end local v50    # "who":J
    :cond_6
    move-wide/from16 v46, p4

    .line 779
    .local v46, "originalWindowLength":J
    move-wide/from16 v40, p2

    .line 780
    .local v40, "originalTriggerAtTime":J
    move-wide/from16 v0, p2
    ...
    .line 782
    .local v12, "whenElapsedFromNow":J
    invoke-static {}, Landroid/os/Binder;->getCallingUid()I
    ...
    .line 783
    invoke-direct/range {v7 .. v13}, Lcom/android/server/AlarmManagerService;->needToSync(ILandroid/app/PendingIntent;JJ)Z
    ...
    invoke-virtual/range {v15 .. v21}, Landroid/net/DataSchedulerManager;->getPolicy(ILjava/lang/String;JJ)Landroid/net/DataSchedulerPolicy;

    move-result-object v6

    .line 785
    .local v6, "policy":Landroid/net/DataSchedulerPolicy;
    if-eqz v6, :cond_e

    .line 786
    iget v7, v6, Landroid/net/DataSchedulerPolicy;->policy:I
    ...
    .line 787
    iget-wide v10, v6, Landroid/net/DataSchedulerPolicy;->value:J
    ...
    :cond_7
    :goto_1
    sget-boolean v7, Lcom/android/server/AlarmManagerService;->DEBUG_DATASCHEDULER:Z

    if-eqz v7, :cond_8

    .line 801
    const-string v7, "AlarmManager-DataScheduler"

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "Reschedule: uid ("
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/android/server/AlarmManagerService;->toCurrentTimeString(JI)Ljava/lang/String;
    ...
    const-string v10, ", originalWindowLength="
    ...
    .line 821
    .end local v6    # "policy":Landroid/net/DataSchedulerPolicy;
    :cond_8
    :goto_2
    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/server/AlarmManagerService;->configPowerOffAlarm(IJLandroid/app/PendingIntent;)I
    ...
    :try_start_0
    invoke-direct/range {v22 .. v47}, Lcom/android/server/AlarmManagerService;->setImplLocked(IJJJJJLandroid/app/PendingIntent;ZZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;IJJIIJ)V
    ...
    .end local v16    # "triggerElapsed":J
    .end local v30    # "maxElapsed":J
    .end local v39    # "userId":I
    .restart local v6    # "policy":Landroid/net/DataSchedulerPolicy;
    :cond_a
    iget v7, v6, Landroid/net/DataSchedulerPolicy;->policy:I
    ...
    iget-boolean v7, v0, Lcom/android/server/AlarmManagerService;->mIsControlExactType:Z
    ...
    const-string v9, "Do NOT control this alarm due to WINDOW_EXACT"
    ...
    const-string v9, "set() policy is NULL"
    ...
    .restart local v16    # "triggerElapsed":J
    :cond_f
    const-wide/16 v10, 0x0
    ...
    .line 827
    invoke-static/range {v14 .. v19}, Lcom/android/server/AlarmManagerService;->maxTriggerTime(JJJ)J
...
.method setPowerOffAlarmEnabledImpl(Z)V
    .locals 1
    .param p1, "isOn"    # Z

    .prologue
    .line 861
    iget-boolean v0, p0, Lcom/android/server/AlarmManagerService;->mUsePowerOffAlarm:Z

    if-eqz v0, :cond_0

    .line 862
    invoke-direct {p0, p1}, Lcom/android/server/AlarmManagerService;->poweroff_flag_rtc(Z)V
...
.method triggerAlarmsLocked(Ljava/util/ArrayList;JJ)Z
    ...
    .line 1711
    .restart local v34    # "batch":Lcom/android/server/AlarmManagerService$Batch;
    :cond_2
    move-object/from16 v0, p0
    ...
    .line 1716
    .local v33, "alarm":Lcom/android/server/AlarmManagerService$Alarm;
    const/4 v2, 0x1
    ...
    invoke-virtual/range {v7 .. v13}, Landroid/net/DataSchedulerManager;->getPolicy(ILjava/lang/String;JJ)Landroid/net/DataSchedulerPolicy;

    move-result-object v39

    .line 1736
    .local v39, "policy":Landroid/net/DataSchedulerPolicy;
    if-eqz v39, :cond_b

    .line 1737
    move-object/from16 v0, v39

    iget v2, v0, Landroid/net/DataSchedulerPolicy;->policy:I
    ...
    iget-wide v2, v0, Landroid/net/DataSchedulerPolicy;->value:J

    add-long v8, v42, v2

    .line 1739
    .end local v42    # "triggerAtTime":J
    ...
    .line 1754
    :goto_1
    sget-boolean v2, Lcom/android/server/AlarmManagerService;->DEBUG_DATASCHEDULER:Z

    if-eqz v2, :cond_3

    .line 1755
    const-string v2, "AlarmManager-DataScheduler"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "Reschedule(Repeat): uid ("
    ...
    invoke-direct {v0, v6, v7, v10}, Lcom/android/server/AlarmManagerService;->toCurrentTimeString(JI)Ljava/lang/String;
    ...
    invoke-direct {v0, v8, v9, v6}, Lcom/android/server/AlarmManagerService;->toCurrentTimeString(JI)Ljava/lang/String;
    ...
    const-string v6, ", originalWindowLength="
    ...
    iget-wide v6, v0, Lcom/android/server/AlarmManagerService$Alarm;->originalWindowLength:J
    ...
    iget v6, v0, Lcom/android/server/AlarmManagerService$Alarm;->pid:I
    ...
    .line 1780
    .end local v39    # "policy":Landroid/net/DataSchedulerPolicy;
    :cond_3
    :goto_2
    move-object/from16 v0, v33
    ...
    .line 1741
    .restart local v4    # "whenElapsed":J
    .restart local v14    # "maxElapsed":J
    .restart local v36    # "delta":J
    .restart local v39    # "policy":Landroid/net/DataSchedulerPolicy;
    .restart local v40    # "nextElapsed":J
    .restart local v42    # "triggerAtTime":J
    :cond_7
    move-object/from16 v0, v39
    ...
    iget-wide v2, v0, Lcom/android/server/AlarmManagerService$Alarm;->originalWindowLength:J
    ...
    iget-boolean v2, v0, Lcom/android/server/AlarmManagerService;->mIsControlExactType:Z
    ...
    const-string v3, "Do NOT control this repeat-alarm due to WINDOW_EXACT"
    ...
    .end local v42    # "triggerAtTime":J
    .restart local v8    # "triggerAtTime":J
    goto/16 :goto_1
    ...
    const-string v3, "triggerAlarmsLocked() policy is NULL"
