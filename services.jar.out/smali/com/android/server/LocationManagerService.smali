...
.field private static final MSG_LOCATION_INFORM_LOCK:I = 0x2
...
.method china_CTA_Security_LG(Ljava/lang/String;)V
    .locals 8
    .param p1, "packageName"    # Ljava/lang/String;
    ...
    const-string v6, "china_CTA_Security_LG"
    ...
    invoke-virtual {v5, v6, v7}, Lcom/android/server/LocationManagerService$LocationWorkerHandler;->removeMessages(ILjava/lang/Object;)V
    ...
    invoke-virtual {v5, v4}, Lcom/android/server/LocationManagerService$LocationWorkerHandler;->sendMessageAtFrontOfQueue(Landroid/os/Message;)Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    const-string v7, "requestLocationUpdates:checkLocationAccess:"
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/LocationManagerService;->china_CTA_Security_LG(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    invoke-static {v12, v13}, Landroid/os/Binder;->restoreCallingIdentity(J)V

    .end local v11    # "bCheck":Z
    :goto_0
    return-void
