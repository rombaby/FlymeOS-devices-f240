...
.field private static final WAIT_NORMAL:I = 0x14
...
.method static synthetic access$1700(Lcom/android/server/BluetoothManagerService;ZZI)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # Z
    .param p2, "x2"    # Z
...
.method private loadStoredNameAndAddress()V
    ...
    const-string v2, "invalid bluetooth name and address stored"
    ...
    .line 315
    .local v0, "mPropertyAddress":Ljava/lang/String;
    if-eqz v0, :cond_1
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/BluetoothManagerService;->storeNameAndAddress(Ljava/lang/String;Ljava/lang/String;)V
...
.method private recoverBluetoothServiceFromError()V
    ...
    invoke-direct {p0, v5, v2, v3}, Lcom/android/server/BluetoothManagerService;->waitForOnOff(ZZI)Z
...
.method public disableGattForQuietmode()V
    .locals 2
    ...
    const-string v1, "disableGattForQuietmode()"
...
.method public enable(Ljava/lang/String;)Z
    ...
    const-string v10, "enable():  mBluetooth ="

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget-object v10, p0, Lcom/android/server/BluetoothManagerService;->mBluetooth:Landroid/bluetooth/IBluetooth;
    ...
    iget-boolean v10, p0, Lcom/android/server/BluetoothManagerService;->mBinding:Z
    ...
    invoke-virtual {v0, v8, v1, p1}, Landroid/app/AppOpsManager;->noteOp(IILjava/lang/String;)I
    ...
    .line 499
    .local v4, "enableBtIntent":Landroid/content/Intent;
    ...
    .line 507
    .end local v4    # "enableBtIntent":Landroid/content/Intent;
    :cond_2
...
.method public enableGattForQuietmode()Z
    .locals 5
    ...
    const-string v4, "enableGattForQuietmode()"
    ...
    const-string v3, "enableGattForQuietmode(): Gatt service already enabled...!mBluetoothGatt = "
    ...
    const-string v3, "Not support Bluetooth LE"
    ...
    invoke-virtual {v0, v3, v2}, Landroid/content/Intent;->resolveSystemService(Landroid/content/pm/PackageManager;I)Landroid/content/ComponentName;
...
.method public registerQAdapter(Landroid/bluetooth/IQBluetoothManagerCallback;)Landroid/bluetooth/IQBluetooth;
    ...
    const-string v2, "Callback is null in registerQAdapter"
...
.method public unregisterQAdapter(Landroid/bluetooth/IQBluetoothManagerCallback;)V
    ...
    const-string v2, "Callback is null in unregisterQAdapter"
