...
.field protected static final INJECT_NTP_TIME:I = 0x5

.field protected static final INJECT_NTP_TIME_FINISHED:I = 0xa
...
.field protected static final NTP_INTERVAL:J = 0x5265c00L
...
.field protected static final RETRY_INTERVAL:J = 0x493e0L

.field private static final SET_REQUEST:I = 0x3

.field private static final SIM_STATE_CHANGED:Ljava/lang/String; = "android.intent.action.SIM_STATE_CHANGED"

.field protected static final STATE_DOWNLOADING:I = 0x1

.field protected static final STATE_IDLE:I = 0x2

.field protected static final STATE_PENDING_NETWORK:I = 0x0
...
.field protected final mNtpTime:Landroid/util/NtpTrustedTime;

.field protected mPeriodicTimeInjection:Z
...
.field private mSvMasksBds:[J

.field private mSvMasksGlo:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V
    ...
    .line 388
    iput-boolean v3, p0, Lcom/android/server/location/GpsLocationProvider;->mGNSSPosTest:Z
    ...
    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mSvMasksGlo:[I

    .line 2519
    new-array v0, v5, [J

    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mSvMasksBds:[J
...
.method static synthetic access$1300(Lcom/android/server/location/GpsLocationProvider;)Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$1500(Lcom/android/server/location/GpsLocationProvider;)Lcom/android/internal/location/GpsNetInitiatedHandler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$3302(Lcom/android/server/location/GpsLocationProvider;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$3400(Lcom/android/server/location/GpsLocationProvider;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method private handleUpdateNetworkState(ILandroid/net/NetworkInfo;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/android/server/location/GpsLocationProvider;->sendMessage(IILjava/lang/Object;)V
...
.method private native native_read_sv_status([I[F[F[F[I[I[J)I
.end method
...
.method private reportSvStatus()V
    ...
    iget-object v6, p0, Lcom/android/server/location/GpsLocationProvider;->mSvMasksGlo:[I

    iget-object v7, p0, Lcom/android/server/location/GpsLocationProvider;->mSvMasksBds:[J

    move-object v0, p0

    invoke-direct/range {v0 .. v7}, Lcom/android/server/location/GpsLocationProvider;->native_read_sv_status([I[F[F[F[I[I[J)I
    ...
    iget-object v7, p0, Lcom/android/server/location/GpsLocationProvider;->mSvMasksGlo:[I

    iget-object v8, p0, Lcom/android/server/location/GpsLocationProvider;->mSvMasksBds:[J

    invoke-virtual/range {v0 .. v8}, Lcom/android/server/location/GpsStatusListenerHelper;->onSvStatusChanged(I[I[F[F[F[I[I[J)V
...
.method private startNavigating(Z)V
    ...
    .line 1609
    :cond_3
    iget-boolean v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGNSSPosTest:Z
    ...
    const-string v4, "GNSSPosTest Position Mode "
...
.method public disable()V
    ...
    invoke-virtual {p0, v0, v2, v1}, Lcom/android/server/location/GpsLocationProvider;->sendMessage(IILjava/lang/Object;)V
...
.method protected native native_inject_time(JJI)V
.end method
...
.method public sendExtraCommand(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    sget-object v5, Lcom/android/server/location/GpsLocationProvider;->mVendorName:Ljava/lang/String;
    ...
    const-string v6, "sendExtraCommand:  command "
    ...
    .line 1411
    const-string v4, "lgddm_gps_start"
    ...
    .line 1413
    :cond_2
    const-string v4, "lgddm_gps_stop"
    ...
    .line 1422
    iput-boolean v6, p0, Lcom/android/server/location/GpsLocationProvider;->mGNSSPosTest:Z

    goto :goto_0

    .line 1425
    :cond_4
    iput-boolean v7, p0, Lcom/android/server/location/GpsLocationProvider;->mGNSSPosTest:Z
    ...
    invoke-virtual {p0, v4, v7, v5}, Lcom/android/server/location/GpsLocationProvider;->sendMessage(IILjava/lang/Object;)V
...
.method public updateNetworkState(ILandroid/net/NetworkInfo;)V
    ...
    invoke-virtual {p0, v0, p1, p2}, Lcom/android/server/location/GpsLocationProvider;->sendMessage(IILjava/lang/Object;)V
