...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v4, v5}, Lcom/android/server/notification/NotificationManagerServiceEx;->access$402(Lcom/android/server/notification/NotificationManagerServiceEx;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;

    .line 161
    iget-object v4, p0, Lcom/android/server/notification/NotificationManagerServiceEx$1;->this$0:Lcom/android/server/notification/NotificationManagerServiceEx;

    # getter for: Lcom/android/server/notification/NotificationManagerServiceEx;->dialog:Landroid/app/AlertDialog;
    invoke-static {v4}, Lcom/android/server/notification/NotificationManagerServiceEx;->access$400(Lcom/android/server/notification/NotificationManagerServiceEx;)Landroid/app/AlertDialog;
    ...
    invoke-static {v4}, Lcom/android/server/notification/NotificationManagerServiceEx;->access$500(Lcom/android/server/notification/NotificationManagerServiceEx;)Lcom/android/server/notification/NotificationManagerServiceEx$WorkerHandlerEx;
    ...
    # getter for: Lcom/android/server/notification/NotificationManagerServiceEx;->mHandler:Lcom/android/server/notification/NotificationManagerServiceEx$WorkerHandlerEx;
    invoke-static {v5}, Lcom/android/server/notification/NotificationManagerServiceEx;->access$500(Lcom/android/server/notification/NotificationManagerServiceEx;)Lcom/android/server/notification/NotificationManagerServiceEx$WorkerHandlerEx;
    ...
    invoke-static {v4}, Lcom/android/server/notification/NotificationManagerServiceEx;->access$600(Lcom/android/server/notification/NotificationManagerServiceEx;)Lcom/android/server/notification/NotificationManagerServiceEx$SettingsObserver;

    move-result-object v4

    # invokes: Lcom/android/server/notification/NotificationManagerServiceEx$SettingsObserver;->updateBackPulseEnabled()V
    invoke-static {v4}, Lcom/android/server/notification/NotificationManagerServiceEx$SettingsObserver;->access$700(Lcom/android/server/notification/NotificationManagerServiceEx$SettingsObserver;)V
