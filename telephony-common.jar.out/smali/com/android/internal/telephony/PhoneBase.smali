...
.method protected constructor <init>(Ljava/lang/String;Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;ZI)V
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->MMSC:Ljava/lang/String;

    .line 117
    const/4 v3, 0x0

    iput-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->MMS_PROXY:Ljava/lang/String;
    ...
    iput v3, p0, Lcom/android/internal/telephony/PhoneBase;->mVmCount:I
    ...
    iput-boolean v3, p0, Lcom/android/internal/telephony/PhoneBase;->mIsVideoCapable:Z
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->mEmodeInfoforAndroid:[Ljava/lang/String;

    .line 295
    const/4 v3, 0x0

    iput-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->mSubscriptionData:Lcom/android/internal/telephony/Subscription;
    ...
    iput-boolean v3, p0, Lcom/android/internal/telephony/PhoneBase;->mImsServiceReady:Z
    ...
    invoke-interface {v3, p0, v4, v5}, Lcom/android/internal/telephony/CommandsInterface;->setOnCallRing(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .line 504
    sget-object v3, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_ROAMING_SET_ROAMING_STATUS:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    const-string v4, "[KDDI-DATA] LGP_DATA_ROAMING_SET_ROAMING_STATUS."
    ...
    const-string v4, "[KDDI-DATA] DATA_ROAMING is Not Enabled in Setting DB."
    ...
    invoke-interface {v3, v4, v5}, Lcom/android/internal/telephony/CommandsInterface;->setDataRoamingStatus(ZLandroid/os/Message;)V
    :try_end_0
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/SingleBinary;->updateSystemLanguage()V
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/SingleBinary;->switchCustBaseNTCode()V
    ...
    invoke-interface {v3, p0, v4, v5}, Lcom/android/internal/telephony/CommandsInterface;->registerForSrvccStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v3, p0, v4, v5}, Lcom/android/internal/telephony/CommandsInterface;->setOnUnsolOemHookRaw(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .line 534
    sget-object v3, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_APN_UPDATE_MMS_INFO_FROM_NV:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    const-string v4, "getMmsc, getMmsProxy"
    ...
    invoke-interface {v3, v4}, Lcom/android/internal/telephony/CommandsInterface;->getMmsc(Landroid/os/Message;)V
    ...
    invoke-interface {v3, v4}, Lcom/android/internal/telephony/CommandsInterface;->getMmsProxy(Landroid/os/Message;)V
    ...
    const-string v4, "[KDDI-DATA] Settings.SettingNotFoundException e."
...
.method public checkMvnoMatches(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 1
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->checkMvnoMatches(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public getEmodeInfoPage(I)Ljava/lang/String;
    ...
    .line 2655
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneBase;->mEmodeInfoforAndroid:[Ljava/lang/String;
...
.method public getEngineeringModeInfo(ILandroid/os/Message;)V
    ...
    const-string v2, "Error! This function should never be executed, inactive CDMAPhone."
...
.method public getGPRIItem(ILandroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/internal/telephony/CommandsInterface;->getGPRIItem(ILandroid/os/Message;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v6, "[EVENT_GET_ENGINEERING_MODE_INFO_DONE] EmodeInfo = not NULL"
    ...
    iput-object v5, p0, Lcom/android/internal/telephony/PhoneBase;->mEmodeModemInfo:Ljava/lang/String;

    .line 667
    invoke-virtual {p0}, Lcom/android/internal/telephony/PhoneBase;->makeEngineeringModeInfo()V
    ...
    const-string v6, "[EVENT_GET_ENGINEERING_MODE_INFO_DONE] EmodeInfo = NULL"
...
.method public lgeQueryGprsCellEnvironmentDescription(ILandroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/internal/telephony/CommandsInterface;->lgeQueryGprsCellEnvironmentDescription(ILandroid/os/Message;)V

    .line 1218
    return-void
.end method

.method public lgeRegisterGprsCellInfo(Landroid/os/Handler;ILjava/lang/Object;)V
    .locals 1
    .param p1, "h"    # Landroid/os/Handler;
    .param p2, "what"    # I
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/CommandsInterface;->registerGprsCellInfo(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 1222
    return-void
.end method

.method public lgeUnregisterGprsCellInfo(Landroid/os/Handler;)V
    .locals 1
    .param p1, "h"    # Landroid/os/Handler;
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->unregisterGprsCellInfo(Landroid/os/Handler;)V
...
.method public makeEngineeringModeInfo()V
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->mEmodeModemInfo:Ljava/lang/String;
    ...
    .line 2668
    iget-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->mEmodeInfoforAndroid:[Ljava/lang/String;
...
.method public selectNetworkManually(Lcom/android/internal/telephony/OperatorInfo;Landroid/os/Message;)V
    ...
    iput-object v6, v2, Lcom/android/internal/telephony/PhoneBase$NetworkSelectMessage;->operatorNumeric:Ljava/lang/String;
    ...
    iput-object v6, v2, Lcom/android/internal/telephony/PhoneBase$NetworkSelectMessage;->operatorAlphaLong:Ljava/lang/String;
    ...
    iput-object v6, v2, Lcom/android/internal/telephony/PhoneBase$NetworkSelectMessage;->operatorAlphaShort:Ljava/lang/String;
    ...
    iget-object v7, v2, Lcom/android/internal/telephony/PhoneBase$NetworkSelectMessage;->operatorNumeric:Ljava/lang/String;

    invoke-interface {v6, v5, v7}, Lcom/android/internal/telephony/Phone;->changePlmnNameForMVNO(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object v6, v6, Lcom/android/internal/telephony/ServiceStateTracker;->mSS:Landroid/telephony/ServiceState;
    ...
    :cond_0
    const-string v6, "SHOW_NETWORK_NAME_WHEN_MANUAL_NETWORK_SETTING_FAIL"

    invoke-static {v8, v6}, Lcom/android/internal/telephony/lgeautoprofiling/LgeAutoProfiling;->isSupportedFeature(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 1119
    const-string v6, "SAVE_NETWORK_OPERATOR_SHORT_NAME"
    ...
    const-string v8, "Writing NETWORK_SELECTION_NAME_KEY "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, v2, Lcom/android/internal/telephony/PhoneBase$NetworkSelectMessage;->operatorAlphaShort:Ljava/lang/String;
    ...
    invoke-virtual {p0, v6, v2}, Lcom/android/internal/telephony/PhoneBase;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-interface {v6, v7, v1}, Lcom/android/internal/telephony/CommandsInterface;->setNetworkSelectionModeManual(Ljava/lang/String;Landroid/os/Message;)V
    ...
    iget-object v8, v2, Lcom/android/internal/telephony/PhoneBase$NetworkSelectMessage;->operatorAlphaLong:Ljava/lang/String;
    ...
    const-string v7, "MANUAL_SELECTION_WITH_RAT"
    ...
    invoke-interface {v6, v7, v8, v1}, Lcom/android/internal/telephony/CommandsInterface;->setNetworkSelectionModeManual(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
...
.method public setE911State(IILandroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/CommandsInterface;->setE911State(IILandroid/os/Message;)V
...
.method public setVoiceMessageCount(I)V
    ...
    const-string v3, "if it has saved voice mail count in sim,don\'t display voice mail count"
