...
.field private mEmergencyCallController:Lcom/android/internal/telephony/gsm/EmergencyCallController;
...
.method constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    .line 126
    new-instance v0, Lcom/android/internal/telephony/gsm/EmergencyCallController;
    ...
    invoke-direct {v0, v1, p0, v2}, Lcom/android/internal/telephony/gsm/EmergencyCallController;-><init>(Lcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/gsm/GsmCallTracker;Lcom/android/internal/telephony/CommandsInterface;)V

    iput-object v0, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mEmergencyCallController:Lcom/android/internal/telephony/gsm/EmergencyCallController;
...
.method private updatePhoneState()V
    ...
    .line 533
    iget-object v1, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mEmergencyCallController:Lcom/android/internal/telephony/gsm/EmergencyCallController;
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/gsm/EmergencyCallController;->restoreNetworkType()V
...
.method declared-synchronized dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {p0, v5, p1}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->convertNumberIfNecessary(Lcom/android/internal/telephony/PhoneBase;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, p1}, Landroid/telephony/PhoneNumberUtils;->isLocalEmergencyNumber(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v5, p1, v1}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->setEmergencyCallAutoRetry(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, v5, v2, v1}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->isApn2DisableMode(Landroid/content/Context;ZZ)Z
    :try_end_1
    ...
    iget-object v4, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mEmergencyCallController:Lcom/android/internal/telephony/gsm/EmergencyCallController;
    ...
    iput-object v5, v4, Lcom/android/internal/telephony/gsm/GsmCall;->mState:Lcom/android/internal/telephony/Call$State;

    .line 294
    iget-object v4, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mEmergencyCallController:Lcom/android/internal/telephony/gsm/EmergencyCallController;

    invoke-virtual {v4, p1}, Lcom/android/internal/telephony/gsm/EmergencyCallController;->startEmergencyCall(Ljava/lang/String;)V
...
.method dialInternal(Ljava/lang/String;)V
    .locals 4
    .param p1, "dialString"    # Ljava/lang/String;
    ...
    invoke-interface {v0, p1, v2, v3, v1}, Lcom/android/internal/telephony/CommandsInterface;->dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;Landroid/os/Message;)V
...
.method protected declared-synchronized handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    :goto_5
    const-string v23, "isInEmergencyCall set to false handlePollCalls 1 MT "
    ...
    .line 671
    const-string v23, "ril.cdma.emergencyCall"
    ...
    invoke-virtual {v0, v15, v9}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->handleSrvccConn(ILcom/android/internal/telephony/DriverCall;)V
    ...
    .line 685
    const-string v23, "isInEmergencyCall set to false handlePollCalls 2 call end"
    ...
    .line 703
    const-string v23, "isInEmergencyCall set to false handlePollCalls 3 MT "
    ...
    invoke-direct {v0, v7, v9}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->okUpdateCall(Lcom/android/internal/telephony/gsm/GsmConnection;Lcom/android/internal/telephony/DriverCall;)Z
    ...
    invoke-static {v0, v7, v9}, Lcom/android/internal/telephony/gsm/AttCallStateBroadcaster;->updateCiqConnectionState(Landroid/content/Context;Lcom/android/internal/telephony/gsm/GsmConnection;Lcom/android/internal/telephony/DriverCall;)V
    ...
    invoke-virtual {v0, v15, v7}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->timeOutLGU(ILcom/android/internal/telephony/gsm/GsmConnection;)Z
    ...
    invoke-virtual {v14}, Lcom/android/internal/telephony/Connection;->toString()Ljava/lang/String;
    ...
    invoke-virtual/range {v23 .. v24}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->onDisconnect(I)Z
...
.method pollCallsWhenSafeForEmergencyCallController()V
    .locals 0
