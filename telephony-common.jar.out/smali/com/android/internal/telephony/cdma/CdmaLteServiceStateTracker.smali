...
.method protected handlePollStateResultMessage(ILandroid/os/AsyncResult;)V
    ...
    invoke-virtual {v0, v12}, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->regCodesIsSearching(I)Z

    move-result v15

    invoke-static {v1, v15}, Lcom/lge/telephony/LGServiceState;->setDataSearching(Landroid/telephony/ServiceState;Z)V
...
.method protected pollStateDone()V
    ...
    invoke-static/range {v41 .. v41}, Lcom/lge/telephony/LGServiceState;->getDefault(Landroid/telephony/ServiceState;)Lcom/lge/telephony/LGServiceState;

    move-result-object v41

    invoke-virtual/range {v41 .. v41}, Lcom/lge/telephony/LGServiceState;->getDataRoaming()Z
    ...
    :goto_10
    sget-object v41, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_DATACONNECTION_BUGFIX_SETUP_DATACALL_ON_UNKNOWN_TECH:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;

    invoke-virtual/range {v41 .. v41}, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->getValue()Z
    ...
    .line 464
    sget-object v41, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_IMS_RETRY_NO_USE_PERMANENTFAIL_ON_AFW:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    .line 465
    const-string v41, "ril.current.datatech"
    ...
    .line 519
    sget-object v41, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_DEBUG_RIL_CONN_HISTORY:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    invoke-interface/range {v41 .. v41}, Lcom/android/internal/telephony/CommandsInterface;->getMyDebugger()Lcom/android/internal/telephony/lgdata/MMdebuger;
    ...
    invoke-virtual/range {v41 .. v42}, Lcom/android/internal/telephony/lgdata/MMdebuger;->savecurrenttech(I)V

    .line 526
    :cond_8
    sget-object v41, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_APN_TETHERING_DUN_PDN_SPRINT:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    invoke-static/range {v41 .. v41}, Landroid/telephony/ServiceState;->isCdma(I)Z
    ...
    const-string v42, "tether_dun_required"
    ...
    .line 529
    const-string v41, "pollStateDone: Dun PDN for Tethering from CDMA 1X to LTE"
    ...
    .line 554
    sget-object v41, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_TCPIP_MTU_SET_SYSTEM_PROPERTIES_SPRINT:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    const-string v42, "net.rmnet.activenetwork"
    ...
    const-string v42, "[LG DATA] we set activenetwork : "
    ...
    invoke-static/range {v41 .. v41}, Lcom/android/internal/telephony/lgeautoprofiling/LgeAutoProfiling;->isOperator(Ljava/lang/String;)Z
    ...
    .line 620
    const-string v41, "do not set the operator name from CSIM record.. CTC already set"
    ...
    const-string v43, "ril.cdma.voiceinservice"
    ...
    .line 533
    const-string v41, "pollStateDone: default PDN for Tethering ON GSM and WCDMA"
    ...
    .line 538
    :cond_37
    sget-object v41, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_APN_SELECT_TETHERING_PDN_SPRINT:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    .line 542
    const-string v41, "pollStateDone: Dun PDN for Tethering ON LTE/eHRPD"
    ...
    .line 546
    const-string v41, "pollStateDone: default PDN for Tethering ON NON LTE/eHRPD"
    ...
    invoke-virtual/range {v41 .. v41}, Landroid/telephony/ServiceState;->getRadioTechnology()I
    ...
    const-string v42, "mAttachedRegistrants.notifyRegistrants() CheckATTACH:: "
