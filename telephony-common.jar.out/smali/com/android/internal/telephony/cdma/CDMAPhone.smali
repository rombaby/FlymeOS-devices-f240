...
.field private static final DEFAULT_SUBSCRIPTION_ON_KK:I = 0x0
...
.method private handleEnterEmergencyCallbackMode(Landroid/os/Message;)V
    ...
    const-string v4, "ro.chameleon.itson"
    ...
    invoke-virtual {v3, v6}, Lcom/itsoninc/android/ItsOnOemApi;->setEmergencyMode(Z)V
    ...
    invoke-super {p0, v3, v4}, Lcom/android/internal/telephony/PhoneBaseEx;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
...
.method private handleExitEmergencyCallbackMode(Landroid/os/Message;)V
    ...
    const-string v3, "ro.chameleon.itson"
...
.method private upgradeVoiceMailCountG3()V
    .locals 9
    ...
    const-string v7, "upgradeVoicemailCountG3 subId : "
    ...
    .line 1139
    .local v3, "oldVmId":Ljava/lang/String;
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "upgradeVoicemailCountG3 oldVmId = "
    ...
    .line 1142
    const-string v6, "upgradeVoicemailCountG3 started"
    ...
    .line 1145
    .local v2, "oldVmCount":I
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "upgradeVoicemailCountG3 oldVmCount = "
    ...
    const-string v7, "cdma_urgent_vmwi"
    ...
    const-string v7, "vm_priority_key"
    ...
    const-string v7, "upgradeVoicemailCountG3 isUrgent = "
    ...
    .line 1156
    .end local v1    # "isUrgent":Z
    :cond_1
    const-string v6, "upgradeVoicemailCountG3 upgrading completed"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1530
    sget-object v3, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_UPDATE_CURRENT_CARRIER_IN_PROVIDER_CTC:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    const-string v4, "[LGE_DATA_CTC] updateCurrentCarrierInProvider() BLOCK!!"
...
.method protected init(Landroid/content/Context;Lcom/android/internal/telephony/PhoneNotifier;)V
    ...
    .line 221
    :cond_0
    sget-object v5, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_DATACONNECTION_LGONESOURCE_FROM_ORIGINAL:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    .line 222
    new-instance v5, Lcom/android/internal/telephony/lgdata/LgDcTracker;
    ...
    invoke-direct {v5, v6, p0}, Lcom/android/internal/telephony/lgdata/LgDcTracker;-><init>(Lcom/android/internal/telephony/dataconnection/DcTrackerBase;Lcom/android/internal/telephony/PhoneBase;)V

    iput-object v5, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mLgDcTracker:Lcom/android/internal/telephony/lgdata/LgDcTracker;
    ...
    const-string v6, "ro.chameleon.itson"
    ...
    invoke-virtual {p0, p1, v2}, Lcom/android/internal/telephony/cdma/CDMAPhone;->setOperatorAlpha(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5, v3, v6, v7}, Lcom/android/internal/telephony/SubscriptionController;->setMccMnc(Ljava/lang/String;J)I

    .line 289
    :cond_5
    invoke-virtual {p0, v3}, Lcom/android/internal/telephony/cdma/CDMAPhone;->setIsoCountryProperty(Ljava/lang/String;)V
...
.method protected updateVoiceMail()V
    ...
    const-string v1, "keep_voicemail_onupgrade_g3los"
    ...
    .line 1114
    invoke-direct {p0}, Lcom/android/internal/telephony/cdma/CDMAPhone;->upgradeVoiceMailCountG3()V
