...
.field private static final DEFAULT_REENABLE_DELAY_MS:J = 0x3e8L
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/wifi/WifiServiceImpl;Landroid/os/Looper;)V
    ...
    invoke-direct {p0, v4, p3}, Lcom/android/internal/util/StateMachine;-><init>(Ljava/lang/String;Landroid/os/Looper;)V
    ...
    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mNetworkInfo:Landroid/net/NetworkInfo;
    ...
    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mTmpWorkSource:Landroid/os/WorkSource;

    .line 144
    new-instance v4, Lcom/android/server/wifi/WifiController$DefaultState;

    invoke-direct {v4, p0}, Lcom/android/server/wifi/WifiController$DefaultState;-><init>(Lcom/android/server/wifi/WifiController;)V

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mDefaultState:Lcom/android/server/wifi/WifiController$DefaultState;

    .line 145
    new-instance v4, Lcom/android/server/wifi/WifiController$StaEnabledState;

    invoke-direct {v4, p0}, Lcom/android/server/wifi/WifiController$StaEnabledState;-><init>(Lcom/android/server/wifi/WifiController;)V

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mStaEnabledState:Lcom/android/server/wifi/WifiController$StaEnabledState;

    .line 146
    new-instance v4, Lcom/android/server/wifi/WifiController$ApStaDisabledState;

    invoke-direct {v4, p0}, Lcom/android/server/wifi/WifiController$ApStaDisabledState;-><init>(Lcom/android/server/wifi/WifiController;)V

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mApStaDisabledState:Lcom/android/server/wifi/WifiController$ApStaDisabledState;

    .line 147
    new-instance v4, Lcom/android/server/wifi/WifiController$StaDisabledWithScanState;

    invoke-direct {v4, p0}, Lcom/android/server/wifi/WifiController$StaDisabledWithScanState;-><init>(Lcom/android/server/wifi/WifiController;)V

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mStaDisabledWithScanState:Lcom/android/server/wifi/WifiController$StaDisabledWithScanState;

    .line 148
    new-instance v4, Lcom/android/server/wifi/WifiController$ApEnabledState;

    invoke-direct {v4, p0}, Lcom/android/server/wifi/WifiController$ApEnabledState;-><init>(Lcom/android/server/wifi/WifiController;)V

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mApEnabledState:Lcom/android/server/wifi/WifiController$ApEnabledState;

    .line 149
    new-instance v4, Lcom/android/server/wifi/WifiController$DeviceActiveState;

    invoke-direct {v4, p0}, Lcom/android/server/wifi/WifiController$DeviceActiveState;-><init>(Lcom/android/server/wifi/WifiController;)V

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mDeviceActiveState:Lcom/android/server/wifi/WifiController$DeviceActiveState;

    .line 150
    new-instance v4, Lcom/android/server/wifi/WifiController$DeviceInactiveState;

    invoke-direct {v4, p0}, Lcom/android/server/wifi/WifiController$DeviceInactiveState;-><init>(Lcom/android/server/wifi/WifiController;)V

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mDeviceInactiveState:Lcom/android/server/wifi/WifiController$DeviceInactiveState;

    .line 151
    new-instance v4, Lcom/android/server/wifi/WifiController$ScanOnlyLockHeldState;

    invoke-direct {v4, p0}, Lcom/android/server/wifi/WifiController$ScanOnlyLockHeldState;-><init>(Lcom/android/server/wifi/WifiController;)V

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mScanOnlyLockHeldState:Lcom/android/server/wifi/WifiController$ScanOnlyLockHeldState;

    .line 152
    new-instance v4, Lcom/android/server/wifi/WifiController$FullLockHeldState;

    invoke-direct {v4, p0}, Lcom/android/server/wifi/WifiController$FullLockHeldState;-><init>(Lcom/android/server/wifi/WifiController;)V

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mFullLockHeldState:Lcom/android/server/wifi/WifiController$FullLockHeldState;

    .line 153
    new-instance v4, Lcom/android/server/wifi/WifiController$FullHighPerfLockHeldState;

    invoke-direct {v4, p0}, Lcom/android/server/wifi/WifiController$FullHighPerfLockHeldState;-><init>(Lcom/android/server/wifi/WifiController;)V

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mFullHighPerfLockHeldState:Lcom/android/server/wifi/WifiController$FullHighPerfLockHeldState;

    .line 154
    new-instance v4, Lcom/android/server/wifi/WifiController$NoLockHeldState;

    invoke-direct {v4, p0}, Lcom/android/server/wifi/WifiController$NoLockHeldState;-><init>(Lcom/android/server/wifi/WifiController;)V

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mNoLockHeldState:Lcom/android/server/wifi/WifiController$NoLockHeldState;

    .line 155
    new-instance v4, Lcom/android/server/wifi/WifiController$EcmState;

    invoke-direct {v4, p0}, Lcom/android/server/wifi/WifiController$EcmState;-><init>(Lcom/android/server/wifi/WifiController;)V

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mEcmState:Lcom/android/server/wifi/WifiController$EcmState;

    .line 159
    iput-object p1, p0, Lcom/android/server/wifi/WifiController;->mContext:Landroid/content/Context;

    .line 160
    iget-object v4, p2, Lcom/android/server/wifi/WifiServiceImpl;->mWifiStateMachine:Lcom/android/server/wifi/WifiStateMachine;

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mWifiStateMachine:Lcom/android/server/wifi/WifiStateMachine;

    .line 161
    iget-object v4, p2, Lcom/android/server/wifi/WifiServiceImpl;->mSettingsStore:Lcom/android/server/wifi/WifiSettingsStore;

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mSettingsStore:Lcom/android/server/wifi/WifiSettingsStore;

    .line 162
    iget-object v4, p2, Lcom/android/server/wifi/WifiServiceImpl;->mLocks:Lcom/android/server/wifi/WifiServiceImpl$LockList;

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mLocks:Lcom/android/server/wifi/WifiServiceImpl$LockList;

    .line 164
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mContext:Landroid/content/Context;
    ...
    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mAlarmManager:Landroid/app/AlarmManager;
    ...
    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mIdleIntent:Landroid/app/PendingIntent;

    .line 168
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mDefaultState:Lcom/android/server/wifi/WifiController$DefaultState;

    invoke-virtual {p0, v4}, Lcom/android/server/wifi/WifiController;->addState(Lcom/android/internal/util/State;)V

    .line 169
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mApStaDisabledState:Lcom/android/server/wifi/WifiController$ApStaDisabledState;
    ...
    invoke-virtual {p0, v4, v5}, Lcom/android/server/wifi/WifiController;->addState(Lcom/android/internal/util/State;Lcom/android/internal/util/State;)V

    .line 170
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mStaEnabledState:Lcom/android/server/wifi/WifiController$StaEnabledState;
    ...
    .line 171
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mDeviceActiveState:Lcom/android/server/wifi/WifiController$DeviceActiveState;
    ...
    .line 172
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mDeviceInactiveState:Lcom/android/server/wifi/WifiController$DeviceInactiveState;
    ...
    .line 173
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mScanOnlyLockHeldState:Lcom/android/server/wifi/WifiController$ScanOnlyLockHeldState;
    ...
    .line 174
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mFullLockHeldState:Lcom/android/server/wifi/WifiController$FullLockHeldState;
    ...
    .line 175
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mFullHighPerfLockHeldState:Lcom/android/server/wifi/WifiController$FullHighPerfLockHeldState;
    ...
    .line 176
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mNoLockHeldState:Lcom/android/server/wifi/WifiController$NoLockHeldState;
    ...
    .line 177
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mStaDisabledWithScanState:Lcom/android/server/wifi/WifiController$StaDisabledWithScanState;
    ...
    .line 178
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mApEnabledState:Lcom/android/server/wifi/WifiController$ApEnabledState;
    ...
    .line 179
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mEcmState:Lcom/android/server/wifi/WifiController$EcmState;
    ...
    .line 181
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mSettingsStore:Lcom/android/server/wifi/WifiSettingsStore;
    ...
    const-string v5, ", isScanningAvailable = "
    ...
    invoke-virtual {p0, v4}, Lcom/android/server/wifi/WifiController;->log(Ljava/lang/String;)V

    .line 196
    const-string v4, "ro.lge.gons.enable"
    ...
    invoke-virtual {p0, v4}, Lcom/android/server/wifi/WifiController;->setInitialState(Lcom/android/internal/util/State;)V

    .line 207
    :goto_0
    const/16 v4, 0x64

    invoke-virtual {p0, v4}, Lcom/android/server/wifi/WifiController;->setLogRecSize(I)V
    ...
    new-instance v5, Lcom/android/server/wifi/WifiController$1;

    invoke-direct {v5, p0}, Lcom/android/server/wifi/WifiController$1;-><init>(Lcom/android/server/wifi/WifiController;)V

    new-instance v6, Landroid/content/IntentFilter;

    invoke-direct {v6, v0}, Landroid/content/IntentFilter;-><init>(Landroid/content/IntentFilter;)V
    ...
    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mWifiServerServiceExt:Lcom/lge/wifi/extension/IWifiServerServiceExt;

    .line 235
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mWifiServerServiceExt:Lcom/lge/wifi/extension/IWifiServerServiceExt;
    ...
    invoke-interface {v4}, Lcom/lge/wifi/extension/IWifiServerServiceExt;->getWifiOffDelayIfNotUsed()Lcom/lge/wifi/extension/WifiOffDelayIfNotUsedIface;

    move-result-object v4

    iput-object v4, p0, Lcom/android/server/wifi/WifiController;->mWifiOffDelayIfNotUsed:Lcom/lge/wifi/extension/WifiOffDelayIfNotUsedIface;

    .line 241
    iget-object v4, p0, Lcom/android/server/wifi/WifiController;->mWifiOffDelayIfNotUsed:Lcom/lge/wifi/extension/WifiOffDelayIfNotUsedIface;
    ...
    iget-object v5, p0, Lcom/android/server/wifi/WifiController;->mIdleIntent:Landroid/app/PendingIntent;

    invoke-interface {v4, v5}, Lcom/lge/wifi/extension/WifiOffDelayIfNotUsedIface;->init(Landroid/app/PendingIntent;)V
    ...
    :cond_3
    iput-object v9, p0, Lcom/android/server/wifi/WifiController;->mWifiServerServiceExt:Lcom/lge/wifi/extension/IWifiServerServiceExt;

    .line 247
    iput-object v9, p0, Lcom/android/server/wifi/WifiController;->mWifiOffDelayIfNotUsed:Lcom/lge/wifi/extension/WifiOffDelayIfNotUsedIface;
...
.method static synthetic access$1200(Lcom/android/server/wifi/WifiController;)Lcom/lge/wifi/extension/IWifiServerServiceExt;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;

    .prologue
    .line 67
    iget-object v0, p0, Lcom/android/server/wifi/WifiController;->mWifiServerServiceExt:Lcom/lge/wifi/extension/IWifiServerServiceExt;
...
.method static synthetic access$2800(Lcom/android/server/wifi/WifiController;)Lcom/android/server/wifi/WifiController$ApStaDisabledState;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;
...
.method static synthetic access$3100(Lcom/android/server/wifi/WifiController;)Lcom/android/server/wifi/WifiController$EcmState;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;
...
.method static synthetic access$3700(Lcom/android/server/wifi/WifiController;Landroid/os/Message;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;
