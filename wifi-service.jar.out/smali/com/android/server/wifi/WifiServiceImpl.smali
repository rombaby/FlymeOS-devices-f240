...
.field protected mWifiController:Lcom/android/server/wifi/WifiController;
...
.field protected mWifiWatchdogStateMachine:Lcom/android/server/wifi/WifiWatchdogStateMachine;

.field private scanRequestCounter:I

.field protected wifiThread:Landroid/os/HandlerThread;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/wifi/WifiServiceImpl$LockList;-><init>(Lcom/android/server/wifi/WifiServiceImpl;Lcom/android/server/wifi/WifiServiceImpl$1;)V
    ...
    .line 139
    iput-boolean v2, p0, Lcom/android/server/wifi/WifiServiceImpl;->isWFCStateRegistered:Z
    ...
    iput-object v0, p0, Lcom/android/server/wifi/WifiServiceImpl;->mBatchedScanners:Ljava/util/List;

    .line 1384
    new-instance v0, Lcom/android/server/wifi/WifiServiceImpl$2;

    invoke-direct {v0, p0}, Lcom/android/server/wifi/WifiServiceImpl$2;-><init>(Lcom/android/server/wifi/WifiServiceImpl;)V
    ...
    iput-object v0, p0, Lcom/android/server/wifi/WifiServiceImpl;->mInterfaceName:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/wifi/WifiServiceImpl;->mInterfaceName:Ljava/lang/String;

    invoke-direct {v0, v1, v2}, Lcom/android/server/wifi/WifiTrafficPoller;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/android/server/wifi/WifiStateMachine;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/server/wifi/WifiTrafficPoller;)V
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/wifi/WifiNotificationController;-><init>(Landroid/content/Context;Lcom/android/server/wifi/WifiStateMachine;)V
    ...
    iput-object v0, p0, Lcom/android/server/wifi/WifiServiceImpl;->wifiThread:Landroid/os/HandlerThread;

    .line 381
    iget-object v0, p0, Lcom/android/server/wifi/WifiServiceImpl;->wifiThread:Landroid/os/HandlerThread;
    ...
    iget-object v1, p0, Lcom/android/server/wifi/WifiServiceImpl;->wifiThread:Landroid/os/HandlerThread;
    ...
    iget-object v2, p0, Lcom/android/server/wifi/WifiServiceImpl;->wifiThread:Landroid/os/HandlerThread;

    invoke-virtual {v2}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v2

    invoke-direct {v0, v1, p0, v2}, Lcom/android/server/wifi/WifiController;-><init>(Landroid/content/Context;Lcom/android/server/wifi/WifiServiceImpl;Landroid/os/Looper;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/wifi/WifiServiceImpl;->mBatchedScanSupported:Z
...
.method static synthetic access$500(Lcom/android/server/wifi/WifiServiceImpl;Landroid/net/wifi/BatchedScanSettings;II)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/WifiServiceImpl;
...
.method static synthetic access$600(Lcom/android/server/wifi/WifiServiceImpl;)Z
    ...
    .prologue
    .line 92
    iget-boolean v0, p0, Lcom/android/server/wifi/WifiServiceImpl;->isWFCStateRegistered:Z
...
.method static synthetic access$602(Lcom/android/server/wifi/WifiServiceImpl;Z)Z
    ...
    .prologue
    .line 92
    iput-boolean p1, p0, Lcom/android/server/wifi/WifiServiceImpl;->isWFCStateRegistered:Z
...
.method public TstartScan(I)Z
    ...
    iput-object v5, v3, Landroid/net/wifi/ScanSettings;->channelSet:Ljava/util/Collection;
    ...
    .line 2047
    :pswitch_0
    invoke-virtual {p0, v7, v7}, Lcom/android/server/wifi/WifiServiceImpl;->startScan(Landroid/net/wifi/ScanSettings;Landroid/os/WorkSource;)V

    .line 2079
    :goto_1
    iget-object v5, p0, Lcom/android/server/wifi/WifiServiceImpl;->mWifiStateMachine:Lcom/android/server/wifi/WifiStateMachine;

    invoke-virtual {v5, v4}, Lcom/android/server/wifi/WifiStateMachine;->setSelectiveScanValue(Z)V
    ...
    .line 2053
    iget-object v5, v3, Landroid/net/wifi/ScanSettings;->channelSet:Ljava/util/Collection;

    new-instance v6, Landroid/net/wifi/WifiChannel;

    invoke-direct {v6, v1, v0}, Landroid/net/wifi/WifiChannel;-><init>(II)V
    ...
    .line 2064
    :cond_2
    invoke-virtual {p0, v3, v7}, Lcom/android/server/wifi/WifiServiceImpl;->startScan(Landroid/net/wifi/ScanSettings;Landroid/os/WorkSource;)V

    goto :goto_1

    .line 2067
    .end local v0    # "channel":I
    .end local v1    # "freqMHz":I
    .end local v2    # "i":I
    :pswitch_2
    const/16 v1, 0x96c

    .line 2068
    .restart local v1    # "freqMHz":I
    const/4 v0, 0x1
...
.method public getWifiRSSIandLoss()[I
    ...
    invoke-virtual {v0}, Lcom/android/server/wifi/WifiStateMachine;->getwifisiginfo()[I
...
.method public setWifiApEnabled(Landroid/net/wifi/WifiConfiguration;Z)V
    ...
    invoke-interface {v1, v3}, Lcom/lge/cappuccino/IMdm;->checkDisabledTetherType(I)Z
    ...
    sget v2, Lcom/lge/internal/R$string;->sp_block_wifi_hotspot_NORMAL:I

    invoke-interface {v1, v2}, Lcom/lge/cappuccino/IMdm;->sendToastMessageId(I)V
...
.method public declared-synchronized setWifiEnabled(Z)Z
    ...
    const-string v6, "LGMDMWifiUIAdapter"
    ...
    const-string v4, "setWifiEnabled() MDM Block"
