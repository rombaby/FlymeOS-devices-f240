...
.method private handleReceiver(Landroid/app/ActivityThread$ReceiverData;)V
    ...
    invoke-virtual {v10, v2}, Landroid/content/Intent;->setExtrasClassLoader(Ljava/lang/ClassLoader;)V
    ...
    .line 2562
    invoke-virtual {p1, v2}, Landroid/app/ActivityThread$ReceiverData;->setExtrasClassLoader(Ljava/lang/ClassLoader;)V
    ...
    invoke-virtual {v7, v10, v11}, Landroid/app/LoadedApk;->makeApplication(ZLandroid/app/Instrumentation;)Landroid/app/Application;

    move-result-object v0

    .line 2583
    .local v0, "app":Landroid/app/Application;
    sget-boolean v10, Lcom/lge/config/ThreelmMdmConfig;->THREELM_MDM:Z

    if-eqz v10, :cond_2

    .line 2584
    const-string v10, "PowerSaving3LM"
    ...
    invoke-static {v1}, Landroid/os/IPowerSaving3LMService$Stub;->asInterface(Landroid/os/IBinder;)Landroid/os/IPowerSaving3LMService;

    move-result-object v9

    .line 2586
    .local v9, "service":Landroid/os/IPowerSaving3LMService;
    if-eqz v9, :cond_2
    ...
    invoke-interface {v9, v10}, Landroid/os/IPowerSaving3LMService;->isPackageDisabledWhilePowerSaving(Ljava/lang/String;)Z
    ...
    const-string v12, "Power_saving denies receive of "
    ...
    .end local v9    # "service":Landroid/os/IPowerSaving3LMService;
    :catch_0
    move-exception v5
    ...
    .line 2604
    invoke-virtual {p1, v6}, Landroid/app/ActivityThread$ReceiverData;->sendFinished(Landroid/app/IActivityManager;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    :goto_0
    invoke-virtual {v8}, Landroid/content/BroadcastReceiver;->getPendingResult()Landroid/content/BroadcastReceiver$PendingResult;
    ...
    .end local v8    # "receiver":Landroid/content/BroadcastReceiver;
    :catch_1
    move-exception v5
    ...
    .restart local v8    # "receiver":Landroid/content/BroadcastReceiver;
    :cond_2
    :try_start_3
    ...
    .line 2598
    invoke-virtual {v8, p1}, Landroid/content/BroadcastReceiver;->setPendingResult(Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    invoke-virtual {v8, v10, v11}, Landroid/content/BroadcastReceiver;->onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    :try_end_3
    ...
    invoke-virtual {v10, v8, v5}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
...
.method private performStopActivityInner(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/app/ActivityThread$StopInfo;ZZ)V
    ...
    .end local v0    # "e":Ljava/lang/RuntimeException;
    const-string v1, "Performing stop of activity that is not resumed"
