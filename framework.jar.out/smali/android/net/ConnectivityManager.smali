...
.field public static final MAX_NETWORK_TYPE:I = 0x1c

.field public static final MAX_RADIO_TYPE:I = 0x1c
...
.field public static final TYPE_MOBILE_VTIMS:I = 0x1c
...
.method private requestNetworkForFeatureLocked(Landroid/net/NetworkCapabilities;)Landroid/net/NetworkRequest;
    ...
    const-string v2, "if VZW800 PDN , use VZW property. RestoreTimer = "
    ...
    const-string v2, "if IMS PDN , use INFINITY. RestoreTimer = "
...
.method public getNetPrefer(Ljava/lang/String;)I
    ...
    const-string v2, "ePDG ConnectivityManager getNetPrefer : "
...
.method public setDataBlock(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/net/IConnectivityManager;->setDataBlock(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public startUsingNetworkFeature(ILjava/lang/String;)I
    ...
    const-string v15, "[LGE_DATA-KAF] startUsingNetworkFeature :: networkType : "
    ...
    invoke-interface {v13, v0}, Landroid/net/IConnectivityManager;->getNetworkStatus_for_kt_kaf(I)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_0
    sget-object v13, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_PDN_MPDN_VZW:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    const-string/jumbo v15, "startUsingNetworkFeature for net "
    ...
    const-string v13, "enableVZWAPPAPN"
    ...
    const-string v15, "feature set from "
    ...
    const-string v15, " to enableVZWAPP"
    ...
    sget-object v13, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_DATACONNECTION_VZWAPP_CHECK_PERMISSION_VZW:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    .line 1210
    .local v7, "mSystemImage":Z
    const/4 v6, 0x0

    .line 1211
    .local v6, "mSignedFromVZW":Z
    const/4 v5, 0x0

    .line 1214
    .local v5, "mContainVzwAppApn_MetaTag":Z
    :try_start_1
    move-object/from16 v0, p0

    iget-object v13, v0, Landroid/net/ConnectivityManager;->mService:Landroid/net/IConnectivityManager;

    invoke-interface {v13}, Landroid/net/IConnectivityManager;->isSystemImage()Z
    ...
    invoke-interface {v13}, Landroid/net/IConnectivityManager;->isSignedFromVZW()Z
    ...
    invoke-interface {v13}, Landroid/net/IConnectivityManager;->isContainVzwAppApn_MetaTag()Z
    :try_end_1
    ...
    const-string/jumbo v15, "mSystemImage : "
    ...
    const-string v15, " mSignedFromVZW : "
    ...
    const-string v15, " mContainVzwAppApn_MetaTag : "
    ...
    .line 1247
    .end local v5    # "mContainVzwAppApn_MetaTag":Z
    .end local v6    # "mSignedFromVZW":Z
    .end local v7    # "mSystemImage":Z
    :cond_3
    :goto_1
    ...
    .line 1251
    .local v3, "isConnectedOrConnecting":Z
    if-nez v10, :cond_8
    ...
    .line 1217
    .end local v3    # "isConnectedOrConnecting":Z
    .end local v10    # "netCap":Landroid/net/NetworkCapabilities;
    .restart local v5    # "mContainVzwAppApn_MetaTag":Z
    .restart local v6    # "mSignedFromVZW":Z
    .restart local v7    # "mSystemImage":Z
    :catch_1
    move-exception v1
    ...
    const-string v15, " to enableHIPRI"
    ...
    .end local v6    # "mSignedFromVZW":Z
    .end local v7    # "mSystemImage":Z
    .restart local v3    # "isConnectedOrConnecting":Z
    .restart local v10    # "netCap":Landroid/net/NetworkCapabilities;
    :cond_8
    sget-object v13, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_APN_BLOCK_APP_REQUEST_WHEN_USER_DATA_DISABLED:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    const-string v13, "enableEMERGENCY"
    ...
    const-string v14, "[LGE_DATA] User Data Disabled, return APN_TYPE_NOT_AVAILABLE for StartUsingNetworkFeature"
    ...
    const-string/jumbo v15, "sLegacyRequests has:"
    ...
    invoke-virtual {v9}, Landroid/net/NetworkCapabilities;->hashCode()I
    ...
    sget-object v13, Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;->LGP_DATA_DROP_NOTIFY_WHEN_USING_TYPE:Lcom/android/internal/telephony/lgdata/LgDataFeature$DataFeature;
    ...
    invoke-direct {v0, v10}, Landroid/net/ConnectivityManager;->inferLegacyTypeForNetworkCapabilities(Landroid/net/NetworkCapabilities;)I
    ...
    const-string v16, "[lg_data] startUsingNetworkFeature (((minfo.getType() :::"
    ...
    const-string v16, "[lg_data]isConnectedOrConnecting = "
    ...
    iget-object v0, v4, Landroid/net/ConnectivityManager$LegacyRequest;->networkRequest:Landroid/net/NetworkRequest;
    ...
    invoke-direct {v0, v4}, Landroid/net/ConnectivityManager;->renewRequestLocked(Landroid/net/ConnectivityManager$LegacyRequest;)V

    .line 1320
    iget-object v13, v4, Landroid/net/ConnectivityManager$LegacyRequest;->currentNetwork:Landroid/net/Network;
    ...
    const-string/jumbo v14, "starting startUsingNetworkFeature APN_ALREADY_ACTIVE "
...
.method public stopUsingNetworkFeature(ILjava/lang/String;)I
    ...
    const-string v4, " to enableVZWAPP"
