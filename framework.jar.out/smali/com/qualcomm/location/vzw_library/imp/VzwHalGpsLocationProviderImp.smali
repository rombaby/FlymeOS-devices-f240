...
.method private declared-synchronized getLocationCallbackHandler(I)Lcom/qualcomm/location/vzw_library/IVzwHalGpsCallback;
    ...
    const-string/jumbo v1, "not matching with active sessoin. drop fix report"
    ...
    const-string/jumbo v1, "no active sessoin. drop fix report"
...
.method private declared-synchronized modeAdjustmentStateMachine_Dormant(Lcom/qualcomm/location/vzw_library/VzwHalCriteria;)V
    ...
    const-string/jumbo v1, "move to Standalone state"
    ...
    const-string/jumbo v1, "move to MSB state"
    ...
    const-string/jumbo v1, "move to MSA state"
    ...
    const-string/jumbo v1, "move to MSB state for request of AFLT or Optimal mode"
...
.method private declared-synchronized modeAdjustmentStateMachine_MSA(Lcom/qualcomm/location/vzw_library/VzwHalCriteria;)V
    ...
    const-string/jumbo v1, "move to Standalone state from MSA"
    ...
    const-string/jumbo v1, "move to MSB state from MSA"
    ...
    const-string/jumbo v1, "move to MSB state from MSA for request of AFLT or Optimal mode"
...
.method private declared-synchronized modeAdjustmentStateMachine_MSB(Lcom/qualcomm/location/vzw_library/VzwHalCriteria;)V
    ...
    const-string/jumbo v1, "override with MSB mode"
...
.method private declared-synchronized modeAdjustmentStateMachine_Standalone(Lcom/qualcomm/location/vzw_library/VzwHalCriteria;)V
    ...
    const-string/jumbo v1, "move to MSB state from MSS"
    ...
    const-string/jumbo v1, "override with Standalone mode"
    ...
    const-string/jumbo v1, "move to MSB state from MSS for request of AFLT or Optimal mode"
...
.method public declared-synchronized start(Lcom/qualcomm/location/vzw_library/VzwHalCriteria;I)Z
    ...
    const-string/jumbo v3, "move back to Dormant state for lack of hint"
